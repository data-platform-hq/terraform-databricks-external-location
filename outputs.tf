output "storage_credential_name" {
  value       = try(databricks_storage_credential.this.name, null)
  description = "Storage Credential name"
}

output "storage_credential_metastore_id" {
  value       = try(databricks_storage_credential.this.metastore_id, null)
...
output "databricks_gcp_service_account" {
  value       = try(databricks_storage_credential.this.databricks_gcp_service_account[0].email, null)
